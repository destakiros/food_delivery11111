  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 animate-fade-in">
      <div className="text-center mb-16">
        <h1 className="text-5xl font-black text-gray-900 mb-4 uppercase tracking-tighter italic">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="bg-white p-10 rounded-[40px] border border-gray-100 shadow-xl group hover:border-[#D62828] transition duration-500">
          <div className="w-12 h-12 bg-red-50 text-[#D62828] rounded-2xl flex items-center justify-center mb-6 font-black text-xl">@</div>
          <h3 className="text-xl font-black text-gray-900 uppercase tracking-tight mb-4">Direct Contact</h3>
        ...
        <div className="bg-white p-10 rounded-[40px] border border-gray-100 shadow-xl group hover:border-[#FFCA3A] transition duration-500">
          <div className="w-12 h-12 bg-yellow-50 text-[#FFCA3A] rounded-2xl flex items-center justify-center mb-6 font-black text-xl">?</div>
          <h3 className="text-xl font-black text-gray-900 uppercase tracking-tight mb-4">Quick FAQ</h3>
          <p className="text-gray-500 text-sm leading-relaxed mb-6">
            Check our common questions regarding delivery times, food safety, and refunds.
          </p>
          <button className="text-gray-900 font-black uppercase tracking-widest text-xs underline decoration-2 underline-offset-4">
            View FAQ Center
          </button>
        </div>
      </div>

      <div className="bg-gray-950 text-white p-12 rounded-[50px] shadow-2xl relative overflow-hidden">
